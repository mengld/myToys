...
public class BirdGame extends JPanel {
    ...
    public BirdGame() throws Exception {
        // 初始化背景图片
        background = ImageIO.read(new FileInputStream("resources/bg.png"));

        // 初始化开始、结束图片
        startImage = ImageIO.read(new FileInputStream("resources/start.png"));
        gameOverImage = ImageIO.read(new FileInputStream("resources/gameover.png"));
